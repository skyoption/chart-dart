...
void _indicatorEntitySerialize(
  ...
  writer.writeString(offsets[12], object.key);
  writer.writeDouble(offsets[13], object.kijunSen);
  writer.writeByte(offsets[14], object.level.index);
  writer.writeDoubleList(offsets[15], object.levels);
  writer.writeString(offsets[16], object.levelsColor);
  writer.writeDouble(offsets[17], object.longEMA);
  ...
  writer.writeDouble(offsets[19], object.maximum);
  writer.writeString(offsets[20], object.name);
  writer.writeLong(offsets[21], object.period);
  writer.writeString(offsets[22], object.secondColor);
  writer.writeDouble(offsets[23], object.senkouSpanA);
  writer.writeDouble(offsets[24], object.senkouSpanB);
  writer.writeLong(offsets[25], object.shift);
  writer.writeDouble(offsets[26], object.shortEMA);
  writer.writeDouble(offsets[27], object.steps);
  ...
  writer.writeDouble(offsets[29], object.strokeWidth);
  writer.writeByte(offsets[30], object.style.index);
  writer.writeDouble(offsets[31], object.tenkanSen);
  writer.writeByte(offsets[32], object.timeframe.index);
  writer.writeByte(offsets[33], object.type.index);
  writer.writeDouble(offsets[34], object.up);
  writer.writeDouble(offsets[35], object.value);
  writer.writeLong(offsets[36], object.windowId);
}
...
IndicatorEntity _indicatorEntityDeserialize(
  ...
  final object = IndicatorEntity(
    ...
    key: reader.readStringOrNull(offsets[12]) ?? '',
    kijunSen: reader.readDoubleOrNull(offsets[13]),
    level:
        _IndicatorEntitylevelValueEnumMap[reader.readByteOrNull(offsets[14])] ??
            Levels.None,
    levels: reader.readDoubleList(offsets[15]) ?? const [],
    levelsColor: reader.readStringOrNull(offsets[16]),
    longEMA: reader.readDoubleOrNull(offsets[17]),
    macd: reader.readObjectOrNull<MACD>(
      offsets[18],
      MACDSchema.deserialize,
      allOffsets,
    ),
    maximum: reader.readDoubleOrNull(offsets[19]),
    name: reader.readStringOrNull(offsets[20]) ?? '',
    period: reader.readLongOrNull(offsets[21]) ?? 5,
    secondColor: reader.readStringOrNull(offsets[22]),
    senkouSpanA: reader.readDoubleOrNull(offsets[23]),
    senkouSpanB: reader.readDoubleOrNull(offsets[24]),
    shift: reader.readLongOrNull(offsets[25]) ?? 0,
    shortEMA: reader.readDoubleOrNull(offsets[26]),
    steps: reader.readDoubleOrNull(offsets[27]),
    stochastic: reader.readObjectOrNull<Stochastic>(
      offsets[28],
      StochasticSchema.deserialize,
      allOffsets,
    ),
    strokeWidth: reader.readDoubleOrNull(offsets[29]) ?? 1.0,
    style:
        _IndicatorEntitystyleValueEnumMap[reader.readByteOrNull(offsets[30])] ??
            ObjectStyle.normal,
    tenkanSen: reader.readDoubleOrNull(offsets[31]),
    timeframe: _IndicatorEntitytimeframeValueEnumMap[
            reader.readByteOrNull(offsets[32])] ??
        Timeframes.All_Timeframes,
    type:
        _IndicatorEntitytypeValueEnumMap[reader.readByteOrNull(offsets[33])] ??
            IndicatorType.MA_SMA,
    up: reader.readDoubleOrNull(offsets[34]),
    value: reader.readDoubleOrNull(offsets[35]) ?? 0,
    windowId: reader.readLongOrNull(offsets[36]) ?? 0,
  );
  object.id = id;
  return object;
}
...
extension IndicatorEntityQuerySortBy
  ...
  QueryBuilder<IndicatorEntity, IndicatorEntity, QAfterSortBy> sortByKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'key', Sort.asc);
    });
  }

  QueryBuilder<IndicatorEntity, IndicatorEntity, QAfterSortBy> sortByKeyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension IndicatorEntityQuerySortThenBy
  ...
  QueryBuilder<IndicatorEntity, IndicatorEntity, QAfterSortBy> thenByKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'key', Sort.asc);
    });
  }

  QueryBuilder<IndicatorEntity, IndicatorEntity, QAfterSortBy> thenByKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'key', Sort.desc);
    });
  }
...
extension IndicatorEntityQueryWhereDistinct
  ...
  QueryBuilder<IndicatorEntity, IndicatorEntity, QDistinct> distinctByKey(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IndicatorEntityQueryProperty
  ...
  QueryBuilder<IndicatorEntity, String, QQueryOperations> keyProperty() {
    return QueryBuilder.apply(this, (query) {
