...
@immutable
class MFIPropertiesScreen extends StatefulWidget {
  final String? name;
  ...
  @override
  State<MFIPropertiesScreen> createState() => _MFIPropertiesScreenState();
}

class _MFIPropertiesScreenState extends State<MFIPropertiesScreen> {
