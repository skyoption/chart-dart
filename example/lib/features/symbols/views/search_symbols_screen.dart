...
@RoutePage()
class SearchSymbolsScreen extends StatefulWidget {
  const SearchSymbolsScreen({super.key});

  @override
  State<SearchSymbolsScreen> createState() => _SearchSymbolsScreenState();
}

class _SearchSymbolsScreenState extends State<SearchSymbolsScreen> {
